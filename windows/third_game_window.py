...
class ThirdGameWindow(QtWidgets.QMainWindow):
    def __init__(self) -> None:
        super(ThirdGameWindow, self).__init__()
        uic.loadUi('ui/third_game_window.ui', self)

        self.puzzle_images = config['texts']['third_game_window']['puzzle_images']
        self.correct_answers = config['texts']['third_game_window']['correct_answers']
        ...
        self.description_label.setText(config['texts']['third_game_window']['description'])
    ...
    def check_answer(self) -> None:
        ...
        if user_answer == self.correct_answer:
            self.timer.stop()
            self.hide()
            from windows.feedback_window3 import FeedbackWindow3
            self.feedback_window = FeedbackWindow3()
